...
int main(int argc, char *argv[]) {
  ...
  string correct[5] = { "correcttf.txt", "correctsa.txt", "correctmc1.txt",
                              "correctmc2.txt", "correctallqs.txt" };
  string student[5] = { "studenttf.txt", "studentsa.txt", "studentmc1.txt",
                              "studentmc2.txt", "studentallqs.txt" };
