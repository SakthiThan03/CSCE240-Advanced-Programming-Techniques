...
testSongRecordingConstructors1 : testSongRecordingConstructors1.cc SongRecording.o
	$(link) $^
	./a.out

testSongRecordingCopyConstructor : testSongRecordingCopyConstructor.cc SongRecording.o
	$(link) $^
	./a.out

testSongRecordingAssignment : testSongRecordingAssignment.cc SongRecording.o
	$(link) $^
	./a.out
